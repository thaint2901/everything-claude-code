...
- Don't run `node tests/run-all.js` on your own after a modify — it's slow. Run the touched test file(s) standalone, then suggest the full suite and only run it if the user agrees.
