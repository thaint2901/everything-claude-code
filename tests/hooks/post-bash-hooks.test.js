...
if (test('stderr contains PR URL when using real tool_response shape (no tool_output)', () => {
  // Claude Code sends the Bash result under tool_response: {stdout, stderr, ...},
  // never tool_output. This mirrors the real payload shape.
  const input = JSON.stringify({
    tool_input: { command: 'gh pr create --title "Fix bug" --body "desc"' },
